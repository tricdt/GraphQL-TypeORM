...
export type PostsQuery = { __typename?: 'Query', posts?: Array<{ __typename?: 'Post', id: string, text: string, title: string, createdAt: any, updatedAt: any, textSnippet: string }> | null };
